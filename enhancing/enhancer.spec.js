...
describe('enhancer module', () =>
{
    describe('repair function', () =>
    {
        ...
        {
            const item = {enhancement: 3, durability: 73}
    ...
    describe('succeed function', () =>
    {
        it('increases enhancement by 1', () =>
        {
            ...
            const actualOutput = enhancer.succeed({enhancement: 4}).enhancement
            expect(actualOutput).toBe(expectedOutput)
        })
        it('should have a cap of 20', () =>
        {
            const expectedOutput = 20
            const actualOutput = enhancer.succeed({enhancement: 20}).enhancement
            expect(actualOutput).toBe(expectedOutput)
        })
        it('should not alter the durability of the item', () =>
        {
            const expectedOutput = 43
            const actualOutput = enhancer.succeed({durability: 43, enhancement: 4}).durability
            expect(actualOutput).toBe(expectedOutput)
        })
    })
    ...
    describe('fail function', () =>
    {
        it('should lower durability by 5, if enhancement is less than 15', () =>
        {
            ...
            const actualOutput = enhancer.fail({enhancement: 4, durability: 67}).durability
            expect(actualOutput).toBe(expectedOutput)
        })
        it('should lower durability by 10, if enhancement is greater than or equal to 15', () =>
        {
            const expectedOutput = 45
            const actualOutput = enhancer.fail({enhancement: 17, durability: 55}).durability
            expect(actualOutput).toBe(expectedOutput)
        })
        it('should lower enhancement by 1, if enhancement is greater than 16', () =>
        {
            const expectedOutput = 16
            const actualOutput = enhancer.fail({enhancement: 17, durability: 55}).enhancement
            expect(actualOutput).toBe(expectedOutput)
        })
        it('should keep enhancement the same, if enhancement is less than or equal to 16', () =>
        {
            const expectedOutput = 16
            const actualOutput = enhancer.fail({enhancement: 16, durability: 55}).enhancement
            expect(actualOutput).toBe(expectedOutput)
        })
    })
